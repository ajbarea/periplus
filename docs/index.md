...
[:material-rocket-launch: Launch the planner](app/){ .md-button .md-button--primary }
[:material-github: Fork it on GitHub](https://github.com/ajbarea/periplus){ .md-button }
...
<div class="feature-card" markdown>
### :material-cellphone-arrow-down: Installs like an app
Add to Home Screen on iOS or Android and it launches full-screen, its own icon, no browser chrome.
</div>
...
<section class="landing-section landing-cta" markdown>
<div class="section-inner" markdown>
